    ...
    <div className="space-y-10 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <UserPlus className="h-4 w-4 text-brand-blue-deep" /> New Client
          </Link>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-10">
           ...
           <div className="bg-white border-2 border-slate-200 rounded-2xl shadow-sm overflow-hidden">
              <div className="p-8 border-b border-slate-200 flex items-center justify-between bg-slate-50/80/50">
                 <h2 className="text-lg font-black text-brand-navy flex items-center gap-3">
                    <Briefcase className="h-5 w-5 text-brand-blue-deep" /> Active Opportunities
                 </h2>
                            ...
                            <div className="flex items-center gap-6">
                               ...
                               <div className="space-y-1">
                                  ...
                                  <div className="flex items-center gap-3">
                                     ...
                                     <span className="text-[10px] font-black text-brand-blue-deep uppercase tracking-widest">{deal.stage.replace('_', ' ')}</span>
                                  </div>
                               </div>
                            </div>
        ...
        <div className="space-y-8">
           <div className="p-10 bg-brand-navy rounded-2xl text-white shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-xs font-black uppercase tracking-[0.2em] text-brand-blue-pale mb-8">Interaction Radar</h3>
              ...
              <Link 
                ...
                className="w-full py-5 bg-brand-blue-deep rounded-[24px] text-[10px] font-black uppercase tracking-[0.2em] text-white hover:bg-brand-blue-deep-light shadow-xl transition-all shadow-brand-blue-deep/20 active:scale-95 flex items-center justify-center gap-3"
              >
           ...
           <div className="p-8 bg-white border-2 border-slate-200 rounded-2xl shadow-sm">
              <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-600 mb-6 flex items-center gap-2">
                 <Target className="h-4 w-4 text-brand-blue-deep" /> Conversion Pulse
              </h3>
              <div className="space-y-6">
                 <div>
                    ...
                    <div className="h-1.5 w-full bg-slate-50/80 rounded-full overflow-hidden">
                       <div className="h-full bg-brand-blue-deep" style={{ width: '32%' }} />
                    </div>
                 </div>
