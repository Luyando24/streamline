...
import { InventoryMaster } from "@/components/erp/InventoryMaster"
import { RegisterSkuButton } from "@/components/erp/RegisterSkuButton"
    ...
    <div className="space-y-10 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <p className="text-slate-700 font-medium tracking-tight">Real-time stock tracking, multi-node fulfillment, and valuation.</p>
        </div>
      ...
      <div className="grid lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 space-y-8">
           <InventoryMaster initialItems={items} />
        </div>
              ...
              <div className="space-y-8 mb-10">
                 <div className="flex items-center gap-5">
                    ...
                    <div>
                       ...
                       <div className="text-[9px] font-bold opacity-40 uppercase tracking-widest tracking-tighter">Mark goods as received</div>
                    </div>
                 </div>
                 <div className="flex items-center gap-5">
                    <div className="h-10 w-10 rounded-2xl bg-white/5 flex items-center justify-center shadow-inner border border-white/5">
                    ...
                    <div>
                       ...
                       <div className="text-[9px] font-bold opacity-40 uppercase tracking-widest tracking-tighter">Inventory release</div>
                    </div>
                 </div>
                 <div className="flex items-center gap-5">
                    <div className="h-10 w-10 rounded-2xl bg-white/5 flex items-center justify-center shadow-inner border border-white/5">
                    ...
                    <div>
                       ...
                       <div className="text-[9px] font-bold opacity-40 uppercase tracking-widest tracking-tighter">Inter-warehouse logistics</div>
                    </div>
                 </div>
              </div>
