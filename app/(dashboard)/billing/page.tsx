  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-slate-500">Manage your subscription, invoices, and billing cycle.</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl border bg-white p-8 shadow-sm">
           ...
           <div className="flex items-center gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100 mb-6">
             ...
             <div>
               ...
               <div className="text-xs text-slate-500">6–15 Users • ZMW 300/mo</div>
             </div>
        ...
        <div className="rounded-2xl border bg-white p-6 shadow-sm flex flex-col justify-center items-center py-12 text-center gap-4">
           ...
           <div>
             ...
             <p className="text-sm text-slate-400">No payment method added yet.</p>
           </div>
