    ...
    <div className="min-h-screen bg-black text-white selection:bg-brand-teal selection:text-black font-sans overflow-x-hidden">
      ...
      <header className="w-full border-b border-white/10 bg-black/50 backdrop-blur-md sticky top-0 z-50">
        <div className="mx-auto flex h-20 items-center justify-between px-6 lg:px-12 max-w-[1400px]">
          ...
          <div className="flex items-center gap-6">
            <Link 
              href="/register" 
              className="inline-flex items-center justify-center rounded-full bg-brand-teal px-8 py-3 text-[13px] font-bold text-black shadow-lg shadow-brand-teal/20 hover:bg-white transition-all underline decoration-2 underline-offset-4"
            >
      ...
      <main className="max-w-[1400px] mx-auto pt-20 pb-40 px-6 lg:px-12 relative z-10">
        ...
        <div className="relative p-12 md:p-20 bg-[#141414] border border-white/10 rounded-[64px] mb-20 overflow-hidden group shadow-2xl">
           <div className="absolute top-0 right-0 h-80 w-80 bg-brand-teal/5 -mr-20 -mt-20 rounded-full blur-[100px] transition-all duration-700 group-hover:bg-brand-teal/10" />
           
           <div className="relative z-10 space-y-8 max-w-3xl">
              <div className="flex items-center gap-4">
                 <div className="h-20 w-20 rounded-3xl bg-white/5 border-2 border-white/10 flex items-center justify-center text-4xl font-black text-brand-teal">
                    {org.name[0]}
                 </div>
                 <div className="space-y-1">
                    <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-brand-teal">
        ...
        <div className="space-y-10">
           <h2 className="text-2xl font-black text-white italic pl-4">Current <span className="text-brand-teal">Opportunities</span></h2>
           ...
           <div className="grid md:grid-cols-2 gap-8">
              {org.jobs.map((job: any) => (
                <Link 
                  ...
                  className="group p-10 bg-[#141414] border border-white/10 rounded-[48px] hover:border-brand-teal/40 transition-all duration-500 flex flex-col justify-between hover:shadow-[0_20px_40px_-15px_rgba(0,214,57,0.1)]"
                >
                   <div className="space-y-8">
                      <div className="flex justify-between items-start">
                         <div className="h-12 w-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-brand-teal group-hover:bg-brand-teal group-hover:text-black transition-all">
                            <Briefcase className="h-6 w-6" />
                         </div>
                         <div className="text-[10px] font-black uppercase tracking-widest text-slate-500 group-hover:text-brand-teal transition-colors">
                            Posted {new Date(job.created_at).toLocaleDateString()}
                         </div>
                      </div>

                      <div>
                         <h3 className="text-2xl font-black text-white mb-2 leading-tight group-hover:text-brand-teal transition-colors">
                            {job.title}
                         </h3>
                   ...
                   <div className="mt-12 pt-8 border-t border-white/5 flex items-center justify-between">
                      <span className="text-[10px] font-black uppercase tracking-widest text-brand-teal">Automated Application</span>
                      <div className="h-10 w-10 rounded-full bg-white/5 flex items-center justify-center text-white group-hover:bg-brand-teal group-hover:text-black transition-all">
