        ...
        <div className="mx-auto flex h-20 items-center justify-between px-6 lg:px-12 max-w-[1400px]">
          ...
          <div className="flex items-center gap-6">
             <div className="hidden md:flex flex-col items-end">
                ...
                <span className="text-sm font-bold text-brand-blue">{job.organization.name}</span>
             </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-[1400px] mx-auto pt-20 pb-40 px-6 lg:px-12 relative z-10 grid lg:grid-cols-3 gap-16">
        ...
        <div className="lg:col-span-2 space-y-16">
           <div className="space-y-6">
              <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-brand-blue bg-brand-blue/5 w-fit px-4 py-1.5 rounded-full border border-brand-blue/10">
              ...
              <div className="flex flex-wrap gap-8 pt-6">
                 <div className="flex items-center gap-2 text-sm font-bold text-slate-300">
                    <Building2 className="h-5 w-5 text-brand-blue" /> {job.department}
                 </div>
                 <div className="flex items-center gap-2 text-sm font-bold text-slate-300">
                    <MapPin className="h-5 w-5 text-brand-blue" /> {job.organization.country} (HQ)
                 </div>
                 <div className="flex items-center gap-2 text-sm font-bold text-slate-300">
                    <Briefcase className="h-5 w-5 text-brand-blue" /> Full-Time
                 </div>
              </div>
           </div>
           ...
           <div className="space-y-8 p-10 bg-[#141414] border border-white/10 rounded-[48px]">
              <div className="flex items-center gap-4 border-b border-white/5 pb-6">
                 <div className="h-12 w-12 rounded-xl bg-white/5 flex items-center justify-center text-brand-blue">
                    <Target className="h-6 w-6" />
                 </div>
                 <h2 className="text-2xl font-black text-white italic">Position <span className="text-brand-blue">Mission</span></h2>
              </div>
           ...
           <div className="space-y-8 p-10 bg-[#141414] border border-white/10 rounded-[48px]">
              <div className="flex items-center gap-4 border-b border-white/5 pb-6">
                 ...
                 <h2 className="text-2xl font-black text-white italic">Core <span className="text-brand-blue">Competencies</span></h2>
              </div>
              <p className="text-slate-400 text-lg leading-relaxed font-medium whitespace-pre-wrap">
                 {job.requirements}
              </p>
        ...
        <div className="lg:col-span-1">
           <div className="sticky top-32 space-y-8">
              <div className="p-10 bg-brand-blue/5 border border-brand-blue/10 rounded-[48px] space-y-8 shadow-2xl">
                 ...
                 <div className="grid grid-cols-1 gap-4 pt-4">
                    <div className="flex items-center gap-3 text-[10px] font-black uppercase tracking-widest text-slate-500">
                       <ShieldCheck className="h-4 w-4 text-brand-blue" /> Guaranteed Integrity
                    </div>
                    <div className="flex items-center gap-3 text-[10px] font-black uppercase tracking-widest text-slate-500">
                       <Zap className="h-4 w-4 text-brand-blue" /> Instant HR Visibility
                    </div>
                 </div>
              </div>

              <div className="p-8 bg-[#141414] border border-white/10 rounded-[40px] flex items-center gap-6 group hover:border-brand-blue/30 transition-all cursor-pointer">
                 <div className="h-12 w-12 rounded-2xl bg-white/5 flex items-center justify-center text-brand-blue group-hover:scale-110 transition-transform">
