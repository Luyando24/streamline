    ...
    <div className="min-h-screen bg-black text-white selection:bg-brand-teal selection:text-black font-sans overflow-x-hidden">
      ...
      <header className="w-full border-b border-white/10 bg-black/50 backdrop-blur-md sticky top-0 z-50">
        <div className="mx-auto flex h-20 items-center justify-between px-6 lg:px-12 max-w-[1400px]">
          <Link href="/" className="flex items-center gap-2">
            <span className="text-2xl font-black tracking-tighter text-brand-teal">Streamline</span>
          ...
          <div className="flex items-center gap-6">
            ...
            <Link 
              href="/register" 
              className="inline-flex items-center justify-center rounded-full bg-brand-teal px-6 py-2.5 text-[13px] font-bold text-black shadow-lg shadow-brand-teal/20 hover:bg-white transition-all"
            >
              Sign up as Talent
            </Link>
          </div>
      ...
      <main className="max-w-[1400px] mx-auto pt-20 pb-40 px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center space-y-6 mb-24">
           <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-teal/5 border border-brand-teal/20 text-brand-teal text-[10px] font-black uppercase tracking-[0.2em] animate-in fade-in slide-in-from-bottom-2 duration-700">
           ...
           <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-tight max-w-4xl mx-auto italic">
              African Corporate <span className="text-brand-teal not-italic">Opportunities.</span>
           </h1>
        ...
        <div className="bg-[#141414] border border-white/10 rounded-[40px] p-4 sm:p-6 mb-16 flex flex-wrap items-center gap-4 shadow-2xl">
           <div className="flex-1 min-w-[300px] relative group">
              <Search className="absolute left-6 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-500 group-focus-within:text-brand-teal transition-colors" />
              <input 
                type="text" 
                placeholder="Search by title, department, or organization..." 
                className="w-full bg-black/40 border border-white/5 rounded-3xl py-4 pl-14 pr-6 text-sm font-bold focus:outline-none focus:ring-1 focus:ring-brand-teal transition-all placeholder:text-slate-600" 
              />
           </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
           {jobs.map((job: any) => (
             <Link 
               ...
               className="group p-10 bg-[#141414] border border-white/10 rounded-[48px] hover:border-brand-teal/40 hover:shadow-[0_20px_60px_-15px_rgba(0,214,57,0.2)] transition-all duration-500 flex flex-col justify-between"
             >
                <div className="space-y-8">
                   <div className="flex justify-between items-start">
                      <div className="h-14 w-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-brand-teal group-hover:bg-brand-teal group-hover:text-black transition-all duration-500">
                         <Briefcase className="h-7 w-7" />
                      </div>
                      <div className="flex flex-col items-end">
                         <div className="px-3 py-1 rounded-full bg-brand-teal/10 border border-brand-teal/20 text-[9px] font-black uppercase tracking-widest text-brand-teal">
                            Active
                         </div>
                   ...
                   <div>
                      <h3 className="text-2xl font-black text-white group-hover:text-brand-teal transition-colors mb-2 leading-tight">
                         {job.title}
                      </h3>
                      <div className="flex items-center gap-3 text-brand-teal text-[11px] font-black uppercase tracking-widest">
                ...
                <div className="mt-12 pt-8 border-t border-white/5 flex items-center justify-between">
                   ...
                   <div className="h-10 w-10 rounded-full bg-white/5 flex items-center justify-center text-white group-hover:bg-brand-teal group-hover:text-black transition-all duration-300">
      ...
      <footer className="py-20 border-t border-white/10 bg-[#080808]">
         <div className="max-w-4xl mx-auto px-6 text-center space-y-10">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white leading-tight">
               Are you a high-performance organization looking to <span className="text-brand-teal">scale?</span>
            </h2>
            <Link 
              href="/register" 
              className="inline-flex items-center gap-3 px-10 py-5 bg-white text-black rounded-full text-sm font-black uppercase tracking-[0.2em] hover:bg-brand-teal transition-all active:scale-[0.98] shadow-2xl"
            >
